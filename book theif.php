...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-20.jpg" alt="">
        <div class="text">
            <h1>Book Theif</h1>
            <h5>By  Markus Zusak</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Book Thief is a story narrated by a compassionate Death who tells us about Liesel,
                 a girl growing up in Germany during World War II. She steals books, learns to read, and finds comfort
                 in words. She and Max, the Jew her family protects, are the only main characters that survive the war.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$7.32</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Book Theif">
          <input type="hidden" name="price" value="7.32">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\TheBookThief">Download</a></div>
