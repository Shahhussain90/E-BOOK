...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-16.jpg" alt="">
        <div class="text">
            <h1>The Intelligent Investor</h1>
            <h5>By Benjamin Graham</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Intelligent Investor by Benjamin Graham, first published in 1949, is a widely
                 acclaimed book on value investing. The book provides strategies on how to successfully use value
                  investing in the stock market.
                 Historically, the book has been one of the most popular books on investing and Graham's legacy remains</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$11.31</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\The Intelligent Investor">Download</a></div>
