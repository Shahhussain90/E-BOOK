...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-39.jpg" alt="">
        <div class="text">
            <h1>David Copperfield</h1>
            <h5>By Charles Dickens</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">Dickens divides the life of Copperfield into two distinct parts, the first recounting
                 the untimely loss of his innocence. In this orphan tale, Copperfield endures the hardships of his mother's death, a wretched 
                education at Salem House, the toiling at Murdstone and Grinby's, and a desperate escape to his aunt's</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$12.10</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="David Copperfield">
          <input type="hidden" name="price" value="12.10">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\david-copperfield">Download</a></div>
