...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-42.jpg" alt="">
        <div class="text">
            <h1>12 Rules for Life</h1>
            <h5>By  Jordan Peterson</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">12 Rules For Life is a story-based, stern yet entertaining self-help manual for 
                young people laying out a set of simple rules to help us become more
                 disciplined, behave better, act with integrity, and balance our lives while enjoying them as much
                  as we can</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <input type="hidden" name="item_name" value="12 Rules for Life">
          <input type="hidden" name="price" value="13.10">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\12-Rules-for-Life">Download</a></div>
