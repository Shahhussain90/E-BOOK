...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-19.jpg" alt="">
        <div class="text">
            <h1>The Lord Of The Rings</h1>
            <h5>By J. R. R. Tolkien.</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Lord of the Rings is an epic high fantasy novel by the English author and scholar
                 J. R. R. Tolkien. Set in Middle-earth, the story began
                 as a sequel to Tolkien's 1937 children's book The Hobbit, but eventually developed into a much larger
                  work</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$13.83</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="The Lord Of The Rings">
          <input type="hidden" name="price" value="13.83">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\The-lord-of-the-rings">Download</a></div>
