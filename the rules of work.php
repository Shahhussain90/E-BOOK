...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-1.jpg" alt="">
        <div class="text">
            <h1>The Rules of Work</h1>
            <h5>By Richard Templer</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">For some people, work's a breeze: they glide effortlessly through all 
                the office politics and back stabbing, always saying and doing the right thing, getting raises,
                 getting promotions, getting results. What do they know that everyone else doesn't? The rules of work.
                  Those rules are surprisingly easy to learn -- and once you know them, they're equally easy to live by.
                   Now, Richard Templar's brought them all together in one place: how to handle conflict without alienating
                      the warriors; how to read your corporate culture; when to speak and when to remain silent; when
                       to stay late and when to leave early.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
              <p class="about">About this book</p>
              <!-- <img class="page-pic" src="images-removebg-preview.png" alt=""> -->
          ...
          <h6 class="pr">Your Price <p class="price">$25</p></h6>
          ...
          <input type="hidden" name="price" value="25">
            ...
            <div class="down">
              <a class="cart-btn" href="download.php?file=pdfS\The_Rules_of_Work">Download</a>
            </div>
