...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-49.jpg" alt="">
        <div class="text">
            <h1>Six of Crows</h1>
            <h5>By Leigh Bardugo</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">Six of Crows tells the story of Kaz Brekker, a brilliant but ruthless conman with a
                 skilled crew of cutthroats, sneak thieves, and spies at his disposal. Kaz and his associates make
                 their own way in a brutal world, trading in secrets, stealing for their own gain, and never looking back.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">12.13</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Six of Crows">
          <input type="hidden" name="price" value="$12.13">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\sig of crows">Download</a></div>
