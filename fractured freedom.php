...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-7.jpg" alt="">
        <div class="text">
            <h1>Fractured Freedom</h1>
            <h5>By Shain Rose</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">Fractured Freedom by Shain Rose is an entertaining and mood-changing novel that 
                can be your all-day partner. This novel does not require any age restriction and tells the
                 importance of relations in our lives and what is their impact. It clearly defines love, as
                  a situation in which the joy of others is necessary for us. A bit slow and boring but you will become
                 regular and it will become an interesting read for you. A wise story that is the source of
                  complete pleasure</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$8.10</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\fractured-freedom">Download</a></div>
