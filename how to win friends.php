...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-41.jpg" alt="">
        <div class="text">
            <h1>How to win friends and influence people</h1>
            <h5>By Dale Carnegie</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">How to Win Friends and Influence People is a 1936 self-help book written by Dale
                 Carnegie. Over 30 million copies have been sold worldwide, making it one of the best-selling
                 books of all time. Carnegie had been conducting business education courses in New York since 1912.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$9.33</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="How to win friends and influence people">
          <input type="hidden" name="price" value="9.33">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\how-to-win-friends-and-influence-people">Download</a></div>
