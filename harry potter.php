...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-36.jpg" alt="">
        <div class="text">
            <h1>Harry Potter and the Sorcerer's Stone</h1>
            <h5>By  J.K. Rowling</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The book is about 11 year old Harry Potter, who receives a letter saying that he is 
                invited to attend Hogwarts, school of witchcraft and wizardry. He then learns that a powerful wizard
                 and his minions are after the sorcerer's stone that will make this evil wizard immortal and undefeatable</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\harry-potter-book-collection-1-4">Download</a></div>
