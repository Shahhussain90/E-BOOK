...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-9.jpg" alt="">
        <div class="text">
            <h1>I Will Teach You To Be Rich</h1>
            <h5>By Ramit Sethi</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">I Will Teach You To Be Rich by Ramit Sethi is a personal finance book that provides
                 actionable advice on budgeting, saving, investing, and
                 earning more money. It offers a step-by-step guide to achieving financial success and living
                  a rich life.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\I Will Teach You To Be Rich">Download</a></div>
