...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-18.jpg" alt="">
        <div class="text">
            <h1>The Silent Patient</h1>
            <h5>By Alex Michaelides</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Silent Patient is a psychological thriller by Alex Michaelides about a dedicated
                 psychotherapist trying to help his patient recover after she refuses
                 to speak following the murder of her husband. Alicia is the woman who killed her husband in cold blood.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$15.90</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="The Silent Patient">
          <input type="hidden" name="price" value="15.90">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\silent-patient">Download</a></div>
