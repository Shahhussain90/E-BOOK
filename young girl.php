...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-22.jpg" alt="">
        <div class="text">
            <h1>The Diary of a Young Girl </h1>
            <h5>By Anne Frank</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Diary of a Young Girl by Anne Frank is a powerful memoir of a teenage girl living
                 in hiding during the Nazi occupation of Amsterdam. It 
                captures the everyday struggles, fears and hopes, and the tenacity of the human spirit in times of 
                adversity.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$16.80</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="The Diary of a Young Girl">
          <input type="hidden" name="price" value="16.80">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Diary of Anne Frank">Download</a></div>
          <!-- <div class="byu"><a class="cart-btn" href="">Buy Now</a></div> -->
          </div>
        </div>
