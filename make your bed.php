...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-45.jpg" alt="">
        <div class="text">
            <h1>Make Your Bed</h1>
            <h5>By William H. McRaven</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The book's main idea is that making your bed every morning is a good way to start 
                building the habits and self-discipline you need to do well in anything. The author says that these
                 seemingly
                 small steps can lead to big changes if taken with a positive attitude and a willingness to work hard</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$16.58</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Make Your Bed">
          <input type="hidden" name="price" value="16.58">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Make-Your-Bed">Download</a></div>
