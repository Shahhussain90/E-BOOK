...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-23.jpg" alt="">
        <div class="text">
            <h1>Becoming</h1>
            <h5>By Michelle Obama</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 "> the book talks about her roots and how she found her voice, as well as her time in
                 the White House, her public
                 health campaign, and her role as a mother. The book is published by Crown and was released in 24 languages</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$11.90</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Becoming">
          <input type="hidden" name="price" value="11.90">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Becoming-Michelle-Obama">Download</a></div>
