...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-4.jpg" alt="">
        <div class="text">
            <h1>How Successful People Think</h1>
            <h5>By John C.Maxewell</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">A Wall Street Journal bestseller, How Successful People Think is the perfect, 
                compact read for today's fast-paced world. America's leadership expert John C. Maxwell will teach 
                you how to be more creative and when to question popular thinking. You'll learn how to capture the
                 big picture while focusing your thinking. You'll find out how to tap into your creative potential,
                  develop shared ideas, and derive lessons from the past to better understand the future.
                 With these eleven keys to more effective thinking, you'll clearly see the path to personal success.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$26.63</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Howsuccessfulpeoplethink">Download</a></div>
