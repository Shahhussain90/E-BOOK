...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-8.jpg" alt="">
        <div class="text">
            <h1>Mindset</h1>
            <h5>By Carol Dweck</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">In her book "Mindset: The New Psychology of Success," Carol S. Dweck argues that
                 a growth mindset—the belief that abilities can be developed and the desire to embrace learning, 
                 challenges, and setbacks 
                as sources of growth—creates the drive and resilience that influence success in virtually every
                 area of life.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$14.74</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Mindset">Download</a></div>
