...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-44.jpg" alt="">
        <div class="text">
            <h1>Atomic Habits</h1>
            <h5>By  James Clear</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
           cvbnm,./  <p class="col-lg-8 ">Atomic Habits presents a proven system for building good habits and breaking bad ones. 
          ...
          <h6 class="pr">Your Price <p class="price">$4.98</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Atomic Habits">
          <input type="hidden" name="price" value="4.98">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\atomichabit">Download</a></div>
