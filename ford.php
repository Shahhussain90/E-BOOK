...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-24.jpg" alt="">
        <div class="text">
            <h1>Henry Ford</h1>
            <h5>By Henry Ford
</h5>
            ...
            <p class="col-lg-8 "> Henry Ford was an American industrialist and business magnate. He was the founder of Ford Motor Company, and chief developer of the assembly line technique of mass production. </p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$14.25</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Henry Ford">
          <input type="hidden" name="price" value="14.25">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\HenryFord.pdf">Download</a></div>
