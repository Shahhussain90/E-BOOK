...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-10.jpg" alt="">
        <div class="text">
            <h1>Finance For The People</h1>
            <h5>Paco De Leon </h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">“Finance for the People” by Paco de Leon is a comprehensive guide that aims to demystify 
                personal finance and empower individuals to take control of their financial lives. The book
                 takes a fresh approach to finance, making it accessible and relatable to readers from all walks of life.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$12.33</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Finance For The People">
          <input type="hidden" name="price" value="12.33">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\PrinciplesofFinance">Download</a></div>
