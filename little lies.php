...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-48.jpg" alt="">
        <div class="text">
            <h1>Big Little Lies</h1>
            <h5>By Liane Moriarty</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">the cleverly told story focuses on three young mothers--Madeline, Celeste and 
                Jane--who are living in a fairly upscale beach community in Australia. Each of the women has
                 her own secrets and tells her own lies--until their world comes tumbling down and one of their own
                  is killed</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <input type="hidden" name="item_name" value="Big Little Lies">
          <input type="hidden" name="price" value="13.10">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\big little lies">Download</a></div>
