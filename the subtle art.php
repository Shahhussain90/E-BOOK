...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-43.jpg" alt="">
        <div class="text">
            <h1>The Subtle Art of Not Giving a F*ck</h1>
            <h5>By Mark Manson</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Subtle Art of Not Giving a F*ck argues that individuals should seek to find 
                meaning through what they find to be important and only engage in values that they can control.
                 Values (such as popularity) that are not under a person's control are, according to the book, 
                 'bad values'.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$13.23</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="The Subtle Art of Not Giving a F*ck">
          <input type="hidden" name="price" value="13.23">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\The Subtle Art of Not Giving a Fck">Download</a></div>
