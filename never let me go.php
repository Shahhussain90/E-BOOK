...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-2.jpg" alt="">
        <div class="text">
          ...
          <h6 class="pr">Your Price <p class="price">$21.75</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Never-Let-Me-Go">Download</a></div>
