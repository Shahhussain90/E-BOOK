...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-34.jpg" alt="">
        <div class="text">
            <h1>The Art of War</h1>
            <h5>By Sun Tzur</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Art of War is a book of conflict knowledge and tactics revolving around several
                 key concepts, including: Knowing
                 when to fight and when not to fight. Knowing how to mislead the enemy. Knowing oneself and one's enemy.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$18.62</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="The Art of War">
          <input type="hidden" name="price" value="18.62">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\The_Art_Of_War">Download</a></div>
