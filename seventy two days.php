...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-40.jpg" alt="">
        <div class="text">
            <h1>Around the World in Seventy-Two Days</h1>
            <h5>By Nellie Bly</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">On January 25, 1890, the world waited for a young reporter named Nellie Bly to
                 arrive back home. For 72 days, as she jumped cargo ships, trains, tugboats, and rickshaws,
                 newspaper readers had been following her progress in one of the most highly publicized journeys of
                  all time.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$13.10</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Around the World in Seventy-Two Days">
          <input type="hidden" name="price" value="13.10">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\world travel Eighty_Days">Download</a></div>
