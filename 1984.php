...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-27.jpg" alt="">
        <div class="text">
            <h1>1984</h1>
            <h5>By  George Orwell</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">1984 is a dystopian novel that was written by George Orwell and published in 1949.
                 It tells the story of Winston Smith, a citizen of the miserable
                 society of Oceania, who is trying to rebel against the Party and its omnipresent symbol, Big Brother.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <div class="down">
            <a class="cart-btn" href="download.php?file=pdfS\1984">Download</a>
          </div>
