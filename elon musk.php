...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-6.jpg" alt="">
        <div class="text">
            <h1>Elon Musk</h1>
            <h5>By Ashlee Vance</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">Elon Musk is the first official biography of the creator of SolarCity, SpaceX and 
                Tesla, based on over 30 hours of conversation time between author Ashlee Vance and Musk himself,
                 highlighting his complicated childhood, the way he makes decisions and 
                navigates the world, and how he managed to disrupt multiple industries, all with the goal of
                 saving humanity.</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$32</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Elon-musk">Download</a></div>
