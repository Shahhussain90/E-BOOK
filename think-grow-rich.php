...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-5" alt="">
        <div class="text">
          ...
          <h6 class="pr">Your Price <p class="price">28.88</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Think-And-Grow-Rich">Download</a></div>
