...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-11.jpg" alt="">
        <div class="text">
            <h1>Automatic millionaire</h1>
            <h5>By David </h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
             <p class="col-lg-8 ">This Book presents a proven system for building good habits and breaking bad ones. 
                ,./w890-The key to building lasting habits is focusing 
                on creating a new identity first. Your current behaviors are simply a reflection of your current identity</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$10</p></h6>
          ...
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\AutoMillionaireWorkbook">Download</a></div>
