...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-3.jpg" alt="">
        <div class="text">
            <h1>The Alchemist</h1>
            <h5>By paulo coelho</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">The Alchemist (1988) follows the story of a young Andalusian shepherd,
                 who travels to the pyramids of Egypt to find a treasure he has recurrently dreamed about. 
                On his journey, he has to overcome multiple obstacles – through which he learns valuable
                 life lessons..</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <input type="hidden" name="item_name" value="The Alchemist">
