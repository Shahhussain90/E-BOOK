...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-25.jpg" alt="">
        <div class="text">
            <h1>Alexander Hamilton</h1>
            <h5>By Ron Chernow</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 "> 'Alexander Hamilton' by Ron Chernow is a biography that delves into the life of one
                 of America's founding fathers. It explores his rise
                 from poverty to becoming a leading politician and his pivotal role in shaping America's financial
                  system</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <input type="hidden" name="item_name" value="Alexander Hamilton">
          <input type="hidden" name="price" value="9.33">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Alexander-Hamilton">Download</a></div>
