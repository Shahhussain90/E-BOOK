...
<div class="responsive-nav">
    ...
    <main>
        ...
        <img class="img" src="imagesMain/img-21.jpg" alt="">
        <div class="text">
            <h1>Steve Jobs</h1>
            <h5>By Walter Isaacson</h5>
            <hr style="width: 70%; text-align: left; margin-left: 0;">
           
            <p class="col-lg-8 ">Based on more than forty interviews with Jobs, the book is an in-depth exploration of
                 who Jobs was, from the story of his birth and subsequent adoption to his massive success at the
                 helm of Apple. Jobs himself personally requested that Isaacson write his biography on a phone call in
                  2004</p>
              <hr style="width: 70%; text-align: left; margin-left: 0;">
              <div class="column">
                <div class="t">
          ...
          <h6 class="pr">Your Price <p class="price">$18.10</p></h6>
          <form action="manage.php" method="POST">
          <div class="cart">
          <button type="submit" name="add_to_cart" class="Add-To-Cart">Add To Cart</button>

          <input type="hidden" name="item_name" value="Steve Jobs">
          <input type="hidden" name="price" value="18.10">
        </form>
          <div class="down"><a class="cart-btn" href="download.php?file=pdfS\Steve Jobs">Download</a></div>
